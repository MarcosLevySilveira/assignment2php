            ...
            if ($customers != null) {
              foreach ($customers as $customer) {
                ...
                <tr>
                  ...
                  <td>
                    <?php echo $customer['programmingLanguages'] ?>
                  </td>
                  <td>
                    <?php echo $customer['favoriteSong'] ?>
                  </td>
                  <td>
                    <?php echo $customer['favoriteMovie'] ?>
                  </td>
                  <td>
                  ...
                  <td>
                    ...
                    <button class="btn btn-danger"><a href="view.php?deleteId=<?php echo $customer['id'] ?>"
